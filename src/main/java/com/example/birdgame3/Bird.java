...
public class Bird {
    ...
    enum HummingbirdSpecialVariant {
        NEUTRAL,
        SIDE,
        UP,
        DOWN
    ...
    enum MockingbirdSpecialVariant {
        NEUTRAL,
        SIDE,
        UP,
        DOWN
    ...
    private record RavenNode(double x, double y, Bird target, RavenPortent ground, int serial, boolean ultimate) {
    }
    ...
    static final int VULTURE_CALL_FRAMES = 42;
    static final int VULTURE_CALL_SPAWN_INTERVAL = 14;
    static final int VULTURE_CALL_MAX_CROWS = 3;
    static final int VULTURE_CROW_TICK_MAX = 3;
    static final int VULTURE_CROW_TICK_RECHARGE_FRAMES = 150;
    static final int VULTURE_NEUTRAL_REUSE_FRAMES = 8;
    static final int VULTURE_GLIDE_FRAMES = 24;
    static final int VULTURE_GLIDE_REUSE_FRAMES = 42;
    static final int VULTURE_THERMAL_FRAMES = 30;
    ...
    int vultureCallTimer = 0;
    int vultureCallHoldFrames = 0;
    int vultureCallCrowsSummoned = 0;
    boolean vultureCallUltimate = false;
    ...
    private static final int RAVEN_MAX_PORTENTS = 3;
    private static final int RAVEN_PORTENT_LIFE_FRAMES = 420;
    ...
    static final int EAGLE_DIVE_FRAMES = 120;
    static final int EAGLE_DIVE_ULTIMATE_FRAMES = 160;
    static final int FALCON_DIVE_FRAMES = 92;
    static final int FALCON_DIVE_ULTIMATE_FRAMES = 130;
    static final int EAGLE_DIVE_GROUND_STARTUP_FRAMES = 10;
    ...
    static final int PHOENIX_FIREBALL_CAST_LOCK_FRAMES = 15;
    static final int PHOENIX_FIREBALL_ULTIMATE_CAST_LOCK_FRAMES = 17;
    static final int PHOENIX_SPIRAL_FRAMES = 28;
    static final int PHOENIX_SPIRAL_ULTIMATE_FRAMES = 36;
    static final int PHOENIX_LAVA_FRAMES = 24;
    static final int PHOENIX_LAVA_ULTIMATE_FRAMES = 30;
    static final int PHOENIX_LAVA_CAST_LOCK_FRAMES = 10;
    static final int PHOENIX_LAVA_ULTIMATE_CAST_LOCK_FRAMES = 12;
    static final int PHOENIX_NEUTRAL_REUSE_FRAMES = 48;
    static final int PHOENIX_NEUTRAL_ULTIMATE_REUSE_FRAMES = 60;
    static final int PHOENIX_FIREBALL_REUSE_FRAMES = 62;
    static final int PHOENIX_FIREBALL_ULTIMATE_REUSE_FRAMES = 74;
    static final int PHOENIX_LAVA_REUSE_FRAMES = 44;
    static final int PHOENIX_LAVA_ULTIMATE_REUSE_FRAMES = 56;
    static final int PHOENIX_BURST_FX_FRAMES = 34;
    ...
    static final int SHOEBILL_THRUST_REUSE_FRAMES = 82;
    static final int SHOEBILL_MARSH_LIFT_FRAMES = 24;
    ...
    static final int HUMMING_FLASH_SIP_FRAMES = 10;
    static final int HUMMING_FLASH_SIP_REUSE_FRAMES = 126;
    static final int HUMMING_HOVER_BURST_REUSE_FRAMES = 160;
    static final int HUMMING_NECTAR_TRAP_REUSE_FRAMES = 210;
    static final int HUMMING_NECTAR_TRAP_LIFE_FRAMES = 330;
    ...
    int hummingNeedleComboCount = 0;
    int hummingNeedleComboTimer = 0;
    int hummingNeedleHitTimer = 0;
    ...
    boolean hummingHoverBurstUsed = false;
    int hummingNectarTrapReuseTimer = 0;
    ...
    static final int ROOSTER_SIDE_REUSE_FRAMES = 18;
    static final int ROOSTER_DOWN_REUSE_FRAMES = 28;
    boolean roosterInitialChicksSpawned = false;
    int roosterNeutralReuseTimer = 0;
    int roosterSideReuseTimer = 0;
    int roosterDownReuseTimer = 0;
    int roosterCommandFxTimer = 0;
    ...
    static final class HummingbirdNectarTrap {
        final double x;
    ...
    static final class VultureBait {
        final double x;
        final double y;
        final boolean ultimate;
        int ageFrames;
    ...
    private static final class RavenPortent {
        double x;
        double y;
        int lifeFrames;
        int ageFrames;
        ...
        RavenPortent(double x, double y, boolean ultimate, int serial) {
            this.x = x;
            this.y = y;
            this.ultimate = ultimate;
            this.serial = serial;
            this.lifeFrames = ultimate ? RAVEN_PORTENT_ULTIMATE_LIFE_FRAMES : RAVEN_PORTENT_LIFE_FRAMES;
        }
    }

    private static final class RavenQuill {
        double x;
        double y;
        double vx;
        double vy;
        ...
        RavenQuill(double x, double y, double vx, double vy, boolean ultimate) {
            this.x = x;
            this.y = y;
            this.vx = vx;
            this.vy = vy;
            this.ultimate = ultimate;
            this.lifeFrames = ultimate ? RAVEN_QUILL_ULTIMATE_LIFE_FRAMES : RAVEN_QUILL_LIFE_FRAMES;
        }
    }

    private static final class RavenDecoy {
        double x;
        double y;
        int lifeFrames;
        int ageFrames;
        ...
        RavenDecoy(double x, double y, boolean ultimate) {
            ...
            this.y = y;
            this.ultimate = ultimate;
            this.lifeFrames = ultimate ? RAVEN_DECOY_ULTIMATE_LIFE_FRAMES : RAVEN_DECOY_LIFE_FRAMES;
        }
    }

    private static final class RavenUltimateRoute {
        double startX;
        double startY;
        double endX;
        double endY;
        ...
        RavenUltimateRoute(double startX, double startY, double endX, double endY) {
            this.startX = startX;
            this.startY = startY;
            this.endX = endX;
            this.endY = endY;
    ...
    int phoenixChargeTimer = 0;
    boolean phoenixCharging = false;
    boolean phoenixChargeUltimate = false;
    int phoenixNeutralReuseTimer = 0;
    int phoenixBurstFxTimer = 0;
    boolean phoenixBurstFxUltimate = false;
    double phoenixBurstFxChargeRatio = 0.0;
    int phoenixCastLockTimer = 0;
    int phoenixFireballReuseTimer = 0;
    int phoenixLavaReuseTimer = 0;
    int phoenixFireballTimer = 0;
    double phoenixFireballX = 0;
    double phoenixFireballY = 0;
    double phoenixFireballVX = 0;
    double phoenixFireballVY = 0;
    boolean phoenixFireballUltimate = false;
    ...
    private void resetMockingbirdCopiedNeutralRuntime() {
        ...
        switch (source) {
            case PIGEON -> PigeonSpecials.reset(this);
            case EAGLE, FALCON -> RaptorSpecials.reset(this);
            case PHOENIX -> PhoenixSpecials.reset(this);
    ...
    int scaledParticleCount(int requested) {
    ...
    private NormalAttackProfile ravenNormalAttackProfile(NormalAttackVariant variant, double facingDir) {
        return switch (variant) {
            case NEUTRAL -> new NormalAttackProfile(108.0, 80.0, facingDir * 18.0, -3.0,
                    0.82, 0.78, 0.94, 0.80, 0.80, 16, 9, AERIAL_LANDING_LAG_FRAMES);
            case SIDE_TILT -> new NormalAttackProfile(140.0, 82.0, facingDir * 34.0, -2.0,
                    0.92, 0.92, 1.08, 0.66, 0.66, 19, 10, AERIAL_LANDING_LAG_FRAMES);
            case UP_TILT -> new NormalAttackProfile(88.0, 138.0, 0.0, -38.0,
                    0.86, 0.90, 0.52, 1.56, 1.56, 18, 10, AERIAL_LANDING_LAG_FRAMES);
    ...
    private void processBirdAttack(Bird other, int dmg, double knockbackScale,
        ...
        if (other.tryRazorbillCounter(this, scaledDamage)) {
            return;
        }
    ...
    private void performAttack(int chargeFrames, NormalAttackVariant variant) {
        ...
        if (!isOnGround()) {
            ...
            clearAerialAttackState();
            if (type == BirdGame3.BirdType.RAVEN && variant == NormalAttackVariant.DOWN_TILT) {
                double portentX = bodyCenterX() + facingDirection() * 42.0 * sizeMultiplier;
    ...
    private void special() {
        BirdSpecialSystem.useSpecial(this);
    }

    private void handleHummingbirdSpecialState() {
        HummingbirdSpecials.handleState(this);
    }
    ...
    private void handleShoebillSpecialState() {
        ShoebillSpecials.handleState(this);
    }
    ...
    void specialHummingbirdNeedleBarrage(boolean ultimate) {
        HummingbirdSpecials.neutral(this, ultimate);
    }

    void specialHummingbirdFlashSip(boolean ultimate) {
        HummingbirdSpecials.side(this, ultimate);
    }

    void specialHummingbirdHoverBurst(boolean ultimate) {
        HummingbirdSpecials.up(this, ultimate);
    }

    void specialHummingbirdNectarTrap(boolean ultimate) {
        HummingbirdSpecials.down(this, ultimate);
    }

    private double hummingbirdTrapSurfaceY(double trapX) {
        return HummingbirdSpecials.trapSurfaceY(this, trapX);
    }
    ...
    void specialShoebillDeathStare(boolean ultimate) {
        ShoebillSpecials.neutral(this, ultimate);
    }

    void specialShoebillHeavyThrust(boolean ultimate) {
        ShoebillSpecials.side(this, ultimate);
    }

    void specialShoebillMarshLift(boolean ultimate) {
        ShoebillSpecials.up(this, ultimate);
    }

    void specialShoebillStatueTrap(boolean ultimate) {
        ShoebillSpecials.down(this, ultimate);
    }

    private boolean shoebillStatueCounterWindowActive() {
        return ShoebillSpecials.statueCounterWindowActive(this);
    }

    private boolean tryShoebillStatueCounter(Bird attacker, double scaledDamage) {
        return ShoebillSpecials.tryStatueCounter(this, attacker, scaledDamage);
    }

    private void emitShoebillReedBurst(double originX, double originY, int dir, int count, Color baseColor) {
        ShoebillSpecials.emitReedBurst(this, originX, originY, dir, count, baseColor);
    }
    ...
    private int dealVultureSpecialDamage(Bird other, double rawDamage, double launchX, double launchY,
        ...
        return VultureSpecials.dealDamage(this, other, rawDamage, launchX, launchY, verb, stunFrames, particleColor);
    }

    private void emitVultureBurst(double centerX, double centerY, double dir, int count, Color color) {
        VultureSpecials.emitBurst(this, centerX, centerY, dir, count, color);
    }

    void specialNullRock(boolean ultimate) {
        VultureSpecials.nullRock(this, ultimate);
    }

    private boolean isRoosterActivePlayerSlot() {
        return RoosterSpecials.isActivePlayerSlot(this);
    }

    private ArrayList<ChickMinion> ownedRoosterChicks() {
        return RoosterSpecials.ownedChicks(this);
    }

    private int ownedRoosterChickCount() {
        return RoosterSpecials.ownedCount(this);
    }

    private int nextRoosterChickVariant() {
        return RoosterSpecials.nextVariant(this);
    }

    private ChickMinion spawnRoosterFollowerChick(int variant, boolean ultimate, int slotHint) {
        return RoosterSpecials.spawnFollower(this, variant, ultimate, slotHint);
    }

    void ensureRoosterStartingChicks() {
        RoosterSpecials.ensureStartingChicks(this);
    }

    private Color roosterChickColor(int variant) {
        return RoosterSpecials.chickColor(variant);
    }

    private void emitRoosterCommandBurst(double centerX, double centerY, Color color, int baseCount) {
        RoosterSpecials.emitCommandBurst(this, centerX, centerY, color, baseCount);
    }

    void specialRoosterCallChick(boolean ultimate) {
        RoosterSpecials.neutral(this, ultimate);
    }

    private ChickMinion nextRoosterFollowerChick() {
        return RoosterSpecials.nextFollower(this);
    }

    private Bird findRoosterThrowTarget(ChickMinion chick, int dir) {
        return RoosterSpecials.findThrowTarget(this, chick, dir);
    }

    void specialRoosterThrowChick(boolean ultimate) {
        RoosterSpecials.side(this, ultimate);
    }

    void specialRoosterCoopBoost(boolean ultimate) {
        RoosterSpecials.up(this, ultimate);
    }

    void specialRoosterRecallChicks(boolean ultimate) {
        RoosterSpecials.down(this, ultimate);
    }
    ...
    void specialPelicanBreakwaterRun(boolean ultimate) {
        boolean empowered = pelicanEmpowered(ultimate);
    ...
    void specialPelicanThermalSail(boolean ultimate) {
    ...
    void specialPelicanBilgeCommand(boolean ultimate) {
        boolean empowered = pelicanEmpowered(ultimate);
        specialCooldown = 0;
        specialMaxCooldown = 0;
        attackAnimationTimer = Math.max(attackAnimationTimer, 8);
    ...
    boolean mockingbirdCopiedNeutralFrom(BirdGame3.BirdType source) {
    ...
    private boolean shoebillSpecialActive() {
        return ShoebillSpecials.active(this);
    }
    ...
    boolean raptorSpecialOnReuseLockout(RaptorSpecialVariant variant) {
        return RaptorSpecials.onReuseLockout(this, variant);
    }
    ...
    private boolean canConvertShieldIntoShoebillDownSpecial() {
        return ShoebillSpecials.canConvertShieldIntoDown(this);
    }
    ...
    boolean canStartRaptorSpecialVariant(RaptorSpecialVariant variant) {
        ...
        return isRaptor()
                ...
                && RaptorSpecials.ready(this, variant);
    }

    boolean canStartPhoenixSpecial() {
        ...
        return type == BirdGame3.BirdType.PHOENIX
                ...
                && (!isBlocking || shieldConversion)
                && !isDodging()
                && !PhoenixSpecials.active(this)
                && (variant != PhoenixSpecialVariant.UP || !phoenixSpiralUsed)
                && PhoenixSpecials.ready(this, variant);
    }

    private boolean hummingbirdSpecialActive() {
        return HummingbirdSpecials.active(this);
    }

    private boolean hummingbirdSpecialReady(HummingbirdSpecialVariant variant) {
        return HummingbirdSpecials.ready(this, variant);
    }

    boolean canStartHummingbirdSpecial() {
        HummingbirdSpecialVariant variant = selectHummingbirdSpecialVariant();
        boolean shieldConversion = HummingbirdSpecials.canConvertShieldIntoDown(this);
    ...
    private boolean roosterSpecialReady(RoosterSpecialVariant variant) {
        return RoosterSpecials.ready(this, variant);
    }

    boolean canStartRoosterSpecial() {
        return RoosterSpecials.canStart(this, grabbedBy != null || grabbedTarget != null, isDodging());
    }
    ...
    private boolean shoebillSpecialReady(ShoebillSpecialVariant variant) {
        return ShoebillSpecials.ready(this, variant);
    }
    ...
    boolean canStartShoebillSpecial() {
    ...
    boolean canStartMockingbirdSpecial() {
    ...
    private boolean vultureSpecialActive() {
        return VultureSpecials.active(this);
    }

    private boolean vultureSpecialReady(VultureSpecialVariant variant) {
        return VultureSpecials.ready(this, variant);
    }
    ...
    boolean hasMockingbirdCapturedType() {
        return mockingbirdCapturedType != null;
    }

    PigeonSpecialVariant selectPigeonSpecialVariant() {
        if (jumpPressed()) {
    ...
    RaptorSpecialVariant selectRaptorSpecialVariant() {
        if (jumpPressed()) {
    ...
    HummingbirdSpecialVariant selectHummingbirdSpecialVariant() {
        if (jumpPressed()) {
    ...
    TurkeySpecialVariant selectTurkeySpecialVariant() {
        if (jumpPressed()) {
    ...
    RoosterSpecialVariant selectRoosterSpecialVariant() {
        if (jumpPressed()) {
    ...
    RoadrunnerSpecialVariant selectRoadrunnerSpecialVariant() {
        if (jumpPressed()) {
    ...
    PenguinSpecialVariant selectPenguinSpecialVariant() {
        if (jumpPressed()) {
    ...
    ShoebillSpecialVariant selectShoebillSpecialVariant() {
        if (jumpPressed()) {
    ...
    MockingbirdSpecialVariant selectMockingbirdSpecialVariant() {
        if (jumpPressed()) {
    ...
    RazorbillSpecialVariant selectRazorbillSpecialVariant() {
        if (jumpPressed()) {
            return RazorbillSpecialVariant.UP;
        }
        if (blockPressed()) {
            return RazorbillSpecialVariant.DOWN;
        }
        if (leftPressed() != rightPressed()) {
            return RazorbillSpecialVariant.SIDE;
        }
        return RazorbillSpecialVariant.NEUTRAL;
    }

    GrinchhawkSpecialVariant selectGrinchhawkSpecialVariant() {
        if (jumpPressed()) {
    ...
    VultureSpecialVariant selectVultureSpecialVariant() {
        if (jumpPressed()) {
    ...
    OpiumSpecialVariant selectOpiumSpecialVariant() {
        if (jumpPressed()) {
    ...
    TitmouseSpecialVariant selectTitmouseSpecialVariant() {
        if (jumpPressed()) {
    ...
    BatSpecialVariant selectBatSpecialVariant() {
        if (jumpPressed()) {
    ...
    PelicanSpecialVariant selectPelicanSpecialVariant() {
        if (jumpPressed()) {
    ...
    RavenSpecialVariant selectRavenSpecialVariant() {
        if (jumpPressed()) {
            return RavenSpecialVariant.UP;
        }
        if (blockPressed()) {
            return RavenSpecialVariant.DOWN;
        }
        if (leftPressed() != rightPressed()) {
            return RavenSpecialVariant.SIDE;
        }
    ...
    private void resetVultureSpecialState(boolean clearObjects) {
        VultureSpecials.reset(this, clearObjects);
    }
    ...
    private void resetHummingbirdSpecialState(boolean clearTraps) {
        HummingbirdSpecials.reset(this, clearTraps);
    }
    ...
    private void interruptHummingbirdSpecialStateOnHit() {
        HummingbirdSpecials.interruptOnHit(this);
    }
    ...
    private void interruptShoebillSpecialStateOnHit() {
        ShoebillSpecials.interruptOnHit(this);
    }

    private void interruptVultureSpecialStateOnHit() {
        VultureSpecials.interruptOnHit(this);
    }
    ...
    void specialBatWingcut(boolean ultimate) {
    ...
    void specialBatMoonrise(boolean ultimate) {
        if (batHanging) {
            releaseBatHang();
        }
    ...
    void specialBatSilentDescent(boolean ultimate) {
        boolean fromHang = batHanging;
    ...
    private void handleRavenSpecialState(boolean specialHeld) {
        if (type != BirdGame3.BirdType.RAVEN) {
            return;
        }

        if (ravenQuillCharging) {
            ravenQuillChargeFrames++;
            vx *= isOnGround() ? 0.84 : 0.94;
            if (!specialHeld || ravenQuillChargeFrames >= RAVEN_QUILL_CHARGE_FAN_FRAMES + 18) {
                fireRavenBlackQuillVolley(ravenQuillChargeFrames >= RAVEN_QUILL_CHARGE_FAN_FRAMES, ravenQuillChargeUltimate);
            }
        }
        ...
        if (ravenSideTimer > 0) {
            ...
            vy *= 0.36;
            if (!ravenSideResolved) {
                applyRavenShadowWarpHits();
                ravenSideResolved = true;
            }
            if ((ravenSideTimer & 1) == 0) {
                emitRavenBurst(bodyCenterX() - ravenSideDirection * 18.0 * sizeMultiplier,
                        bodyCenterY() + 4.0 * sizeMultiplier,
                        ravenSideUltimate ? 6 : 4,
                        ravenSideUltimate ? Color.GOLD : ravenShadowColor(false));
            }
        }
        ...
        if (ravenLiftTimer > 0) {
            ...
            if (!ravenLiftSnapped) {
                ...
                if (snapNode != null) {
                    double oldX = bodyCenterX();
                    double oldY = bodyCenterY();
                    ...
                    emitRavenBurst(bodyCenterX(), bodyCenterY(), ravenLiftUltimate ? 36 : 24,
                            ravenLiftUltimate ? Color.GOLD : ravenAccentColor());
                }
            }
            applyRavenLiftHits();
            if ((ravenLiftTimer & 1) == 0) {
                emitRavenBurst(bodyCenterX(), bodyBottomY() - 6.0 * sizeMultiplier,
                        ravenLiftUltimate ? 7 : 4,
                        ravenLiftUltimate ? Color.GOLD : ravenAccentColor());
            }
        }
    }
    ...
    private void handleRavenQuills() {
        for (Iterator<RavenQuill> it = ravenQuills.iterator(); it.hasNext(); ) {
            ...
            for (Bird other : game.players) {
                if (!canDamageTarget(other)) continue;
                if (Math.abs(other.bodyCenterX() - quill.x) > 18.0 * sizeMultiplier + other.combatHalfWidth()) continue;
                if (Math.abs(other.bodyCenterY() - quill.y) > 18.0 * sizeMultiplier + other.combatHalfHeight()) continue;
                int dealt = applyTrackedSpecialDamage(other, quill.ultimate ? 7 : 5);
                if (dealt > 0) {
                    double dir = Math.signum(quill.vx == 0.0 ? facingDirection() : quill.vx);
                    other.vx += dir * (quill.ultimate ? 7.0 : 5.0);
                    other.vy -= quill.ultimate ? 4.6 : 3.2;
                    applyRavenPortent(other, quill.ultimate);
                    game.playHitSound(dealt);
                    emitRavenBurst(quill.x, quill.y, quill.ultimate ? 18 : 12,
            ...
            Double surfaceY = ravenQuillImpactSurfaceY(prevX, prevY, quill.x, quill.y);
            if (surfaceY != null) {
    ...
    private Double ravenQuillImpactSurfaceY(double prevX, double prevY, double nextX, double nextY) {
        if (prevY <= BirdGame3.GROUND_Y && nextY >= BirdGame3.GROUND_Y) {
            return (double) BirdGame3.GROUND_Y;
        }
        for (Platform platform : game.platforms) {
            boolean isCaveCeiling = game.selectedMap == MapType.CAVE
                    && platform.y <= 1 && platform.h >= 60 && platform.w >= BirdGame3.WORLD_WIDTH - 10;
            if (isCaveCeiling || platform.w <= 0 || platform.h <= 0) continue;
            if (nextX < platform.x - 6.0 || nextX > platform.x + platform.w + 6.0) continue;
    ...
    private void handleRavenGroundPortents() {
        for (Iterator<RavenPortent> it = ravenGroundPortents.iterator(); it.hasNext(); ) {
            RavenPortent portent = it.next();
            portent.ageFrames++;
            portent.lifeFrames--;
            if (portent.lifeFrames <= 0) {
                it.remove();
            } else if ((portent.ageFrames & 15) == 0) {
                emitRavenBurst(portent.x, portent.y - 10.0 * sizeMultiplier,
                        portent.ultimate ? 4 : 3,
                        portent.ultimate ? Color.GOLD : ravenAccentColor());
            }
        }
    }

    private void handleRavenDecoy() {
        if (ravenDecoy == null) {
            return;
        }
        ravenDecoy.ageFrames++;
        ravenDecoy.lifeFrames--;
        if (ravenDecoy.lifeFrames <= 0) {
            ravenDecoy = null;
            return;
        }
        for (Bird other : game.players) {
            if (!canDamageTarget(other)) continue;
            if (other.playerIndex < 0 || other.playerIndex >= ravenDecoy.hit.length) continue;
            if (ravenDecoy.hit[other.playerIndex]) continue;
            double dx = other.bodyCenterX() - ravenDecoy.x;
            double dy = other.bodyCenterY() - ravenDecoy.y;
            if (Math.abs(dx) > 54.0 * sizeMultiplier + other.combatHalfWidth()) continue;
            if (Math.abs(dy) > 68.0 * sizeMultiplier + other.combatHalfHeight()) continue;
            int dealt = applyTrackedSpecialDamage(other, ravenDecoy.ultimate ? 12 : 8);
            if (dealt > 0) {
                other.applyStun(ravenDecoy.ultimate ? 20 : 14);
                other.vx += Math.signum(dx == 0.0 ? facingDirection() : dx) * (ravenDecoy.ultimate ? 12.0 : 8.5);
                other.vy -= ravenDecoy.ultimate ? 8.0 : 5.8;
                applyRavenPortent(other, ravenDecoy.ultimate);
                game.playHitSound(dealt);
            }
            ravenDecoy.hit[other.playerIndex] = true;
            emitRavenBurst(ravenDecoy.x, ravenDecoy.y, ravenDecoy.ultimate ? 44 : 28,
                    ravenDecoy.ultimate ? Color.GOLD : ravenAccentColor());
            ravenDecoy = null;
            return;
        }
    }
    ...
    private void handleRavenUltimateRoutes() {
        for (Iterator<RavenUltimateRoute> it = ravenUltimateRoutes.iterator(); it.hasNext(); ) {
            ...
            route.ageFrames++;
            route.lifeFrames--;
            if (route.lifeFrames <= 0) {
                it.remove();
                continue;
            }
            if ((route.ageFrames & 3) == 0) {
                double t = route.ageFrames / (double) Math.max(1, RAVEN_ULTIMATE_ROUTE_LIFE_FRAMES);
                emitRavenBurst(
                        route.startX + (route.endX - route.startX) * t,
                        route.startY + (route.endY - route.startY) * t,
                        5,
                        Color.GOLD
                );
            }
    ...
    private void applyRavenLiftHits() {
        for (Bird other : game.players) {
            ...
            if (ravenLiftHit[other.playerIndex]) continue;
            double dx = other.bodyCenterX() - bodyCenterX();
            double dy = other.bodyCenterY() - bodyCenterY();
            if (Math.abs(dx) > 72.0 * sizeMultiplier + other.combatHalfWidth()) continue;
            if (dy > 58.0 * sizeMultiplier + other.combatHalfHeight()
                    || dy < -(ravenLiftUltimate ? 148.0 : 122.0) * sizeMultiplier - other.combatHalfHeight()) {
                continue;
            }
            int dealt = applyTrackedSpecialDamage(other, ravenLiftUltimate ? 11 : 7);
            if (dealt > 0) {
    ...
    private void applyRavenRouteDamage(double startX, double startY, double endX, double endY, boolean ultimate) {
        for (Bird other : game.players) {
            if (!canDamageTarget(other)) continue;
            double distance = pointToSegmentDistance(other.bodyCenterX(), other.bodyCenterY(), startX, startY, endX, endY);
            if (distance > (ultimate ? 30.0 : 22.0) * sizeMultiplier + other.combatRadius()) continue;
            int dealt = applyTrackedSpecialDamage(other, ultimate ? 14 : 10);
            if (dealt > 0) {
                double launchDir = Math.signum(other.bodyCenterX() - startX);
                if (launchDir == 0.0) launchDir = facingDirection();
                other.vx += launchDir * (ultimate ? 13.0 : 9.0);
                other.vy -= ultimate ? 8.5 : 6.0;
                other.applyStun(ultimate ? 24 : 16);
                game.playHitSound(dealt);
            }
        }
    }

    private double ravenPortentSurfaceY(double portentX) {
        ...
        for (Platform platform : game.platforms) {
            boolean isCaveCeiling = game.selectedMap == MapType.CAVE
                    && platform.y <= 1 && platform.h >= 60 && platform.w >= BirdGame3.WORLD_WIDTH - 10;
            if (isCaveCeiling || platform.w <= 0 || platform.h <= 0) continue;
            if (portentX < platform.x - 18.0 || portentX > platform.x + platform.w + 18.0) continue;
            if (platform.y < sourceY - 18.0) continue;
            if (platform.y < bestY) {
                bestY = platform.y;
            }
        }
    ...
    void specialRavenBlackQuill(boolean ultimate) {
        ravenQuillCharging = true;
        ravenQuillChargeFrames = 0;
        ravenQuillChargeUltimate = ultimate;
        attackAnimationTimer = Math.max(attackAnimationTimer, 10);
    ...
    void fireRavenBlackQuillVolley(boolean fan, boolean ultimate) {
        ...
        facingRight = dir > 0;
        int count = ultimate ? (fan ? 5 : 3) : (fan ? 3 : 1);
        double spread = ultimate ? 0.22 : 0.18;
        double startX = bodyCenterX() + dir * 32.0 * sizeMultiplier;
        double startY = bodyCenterY() - 10.0 * sizeMultiplier;
        for (int i = 0; i < count; i++) {
            double lane = count == 1 ? 0.0 : i - (count - 1) / 2.0;
            double angle = lane * spread;
            double speed = ultimate ? 18.0 : 15.5;
            ravenQuills.add(new RavenQuill(
                    startX,
                    startY + lane * 5.0 * sizeMultiplier,
                    Math.cos(angle) * speed * dir,
                    Math.sin(angle) * speed * dir,
                    ultimate
            ));
        }
        ravenNeutralReuseTimer = ultimate ? 12 : RAVEN_NEUTRAL_REUSE_FRAMES;
        ravenQuillCharging = false;
        ravenQuillChargeFrames = 0;
        ravenQuillChargeUltimate = false;
        attackAnimationTimer = Math.max(attackAnimationTimer, fan ? 14 : 11);
        emitRavenBurst(startX, startY, ultimate ? 28 : 18, ultimate ? Color.GOLD : ravenAccentColor());
        if (ultimate) {
            game.addToKillFeed(shortName() + " loosed the royal Black Quill volley!");
        }
    }

    void specialRavenShadowWarp(boolean ultimate) {
        int dir = horizontalInputDirection();
        if (dir == 0) {
            dir = facingDirection();
        }
        ...
        RavenNode node = bestRavenWarpNode(dir, ultimate ? 780.0 : 560.0);
        boolean empowered = node != null;
        ravenSideStartX = bodyCenterX();
        ravenSideStartY = bodyCenterY();
        if (node != null) {
            consumeRavenNode(node);
            double arrivalOffset = (node.target() != null ? 56.0 : 34.0) * sizeMultiplier;
            double arrivalDir = node.x() >= bodyCenterX() ? -1.0 : 1.0;
            x = clampRavenWarpX(node.x() + arrivalDir * arrivalOffset - 40.0 * sizeMultiplier);
            y = clampRavenWarpY(node.y() - 40.0 * sizeMultiplier);
            facingRight = arrivalDir < 0.0;
        } else {
            x = clampRavenWarpX(x + dir * (ultimate ? 190.0 : 126.0) * sizeMultiplier);
            y = clampRavenWarpY(y - (ultimate ? 14.0 : 8.0) * sizeMultiplier);
        }
        ravenSideEndX = bodyCenterX();
        ravenSideEndY = bodyCenterY();
        ravenSideDirection = facingDirection();
        ravenSideUltimate = ultimate;
        ravenSideEmpowered = empowered;
        ravenSideResolved = false;
        ravenSideTimer = ultimate ? RAVEN_SIDE_FRAMES + 4 : RAVEN_SIDE_FRAMES;
        ravenSideReuseTimer = ultimate ? 16 : RAVEN_SIDE_REUSE_FRAMES;
        Arrays.fill(ravenSideHit, false);
        specialCooldown = 0;
        specialMaxCooldown = 0;
        attackAnimationTimer = Math.max(attackAnimationTimer, ravenSideTimer + 2);
        vx = facingDirection() * (ultimate ? 8.0 : 5.4);
        vy *= 0.18;
        isBlocking = false;
        parryWindowFrames = 0;
        shieldStunFrames = 0;
        emitRavenBurst(ravenSideStartX, ravenSideStartY, empowered ? 28 : 18, ravenShadowColor(false));
        emitRavenBurst(ravenSideEndX, ravenSideEndY, empowered ? 34 : 22, ultimate ? Color.GOLD : ravenAccentColor());
    }

    void specialRavenMurderLift(boolean ultimate) {
        if (ravenLiftUsed && !ultimate) {
            return;
        }
        ravenLiftUsed = true;
        ravenLiftUltimate = ultimate;
        ...
        specialCooldown = 0;
        specialMaxCooldown = 0;
        emitRavenBurst(bodyCenterX(), bodyBottomY() - 8.0 * sizeMultiplier,
                ultimate ? 42 : 28, ultimate ? Color.GOLD : ravenAccentColor());
    }
    ...
    void specialRavenNevermore(boolean ultimate) {
        ...
        if (ravenDecoy != null && ravenDecoy.lifeFrames > 0) {
            ...
            x = clampRavenWarpX(ravenDecoy.x - 40.0 * sizeMultiplier);
            y = clampRavenWarpY(ravenDecoy.y - 40.0 * sizeMultiplier);
            ravenDecoy.x = oldCenterX;
        ...
        ravenDecoy = new RavenDecoy(bodyCenterX(), bodyCenterY(), ultimate);
        ravenDownReuseTimer = ultimate ? 16 : RAVEN_DOWN_REUSE_FRAMES;
        attackAnimationTimer = Math.max(attackAnimationTimer, 12);
        vx *= 0.72;
        emitRavenBurst(ravenDecoy.x, ravenDecoy.y, ultimate ? 30 : 20, ultimate ? Color.GOLD : ravenAccentColor());
    }

    void specialRavenUnkindness() {
        ArrayList<RavenNode> nodes = activeOwnedRavenNodes();
        if (nodes.isEmpty()) {
            addRavenGroundPortent(bodyCenterX() - 110.0 * sizeMultiplier, ravenPortentSurfaceY(bodyCenterX() - 110.0 * sizeMultiplier), true);
            addRavenGroundPortent(bodyCenterX() + 110.0 * sizeMultiplier, ravenPortentSurfaceY(bodyCenterX() + 110.0 * sizeMultiplier), true);
            nodes = activeOwnedRavenNodes();
        }
        if (nodes.size() == 1) {
            nodes.add(new RavenNode(bodyCenterX(), bodyCenterY(), null, null, ++ravenPortentSerialCounter, true));
        }
    ...
    private void performRavenFinalWarp(Bird target) {
        double startX = bodyCenterX();
        double startY = bodyCenterY();
        double arrivalDir = target.bodyCenterX() >= startX ? -1.0 : 1.0;
        x = clampRavenWarpX(target.bodyCenterX() + arrivalDir * 66.0 * sizeMultiplier - 40.0 * sizeMultiplier);
        y = clampRavenWarpY(target.bodyCenterY() - 40.0 * sizeMultiplier);
        facingRight = arrivalDir < 0.0;
        ravenSideStartX = startX;
        ravenSideStartY = startY;
        ravenSideEndX = bodyCenterX();
        ravenSideEndY = bodyCenterY();
        ravenSideDirection = facingDirection();
        ravenSideUltimate = true;
        ravenSideEmpowered = true;
        ravenSideResolved = false;
        ravenSideTimer = RAVEN_SIDE_FRAMES + 6;
        Arrays.fill(ravenSideHit, false);
    }

    private RavenNode bestRavenWarpNode(int dir, double maxRange) {
        RavenNode best = null;
        double bestScore = Double.MAX_VALUE;
        for (RavenNode node : activeOwnedRavenNodes()) {
            double dx = node.x() - bodyCenterX();
            double dy = node.y() - bodyCenterY();
            double distance = Math.hypot(dx, dy);
            if (distance > maxRange) continue;
            double score = distance + Math.abs(dy) * 0.18;
            if (dx * dir < -28.0) {
                score += 280.0;
            }
            if (score < bestScore) {
    ...
    private RavenNode nearestRavenSnapNode() {
        RavenNode best = null;
        double bestDist = Double.MAX_VALUE;
        for (RavenNode node : activeOwnedRavenNodes()) {
            double dist = Math.hypot(node.x() - bodyCenterX(), node.y() - bodyCenterY());
            if (dist <= RAVEN_LIFT_SNAP_RADIUS * sizeMultiplier && dist < bestDist) {
                bestDist = dist;
                best = node;
            }
        }
    ...
    private ArrayList<RavenNode> activeOwnedRavenNodes() {
        ArrayList<RavenNode> nodes = new ArrayList<>();
        for (RavenPortent portent : ravenGroundPortents) {
            nodes.add(new RavenNode(portent.x, portent.y - 18.0 * sizeMultiplier, null, portent, portent.serial, portent.ultimate));
        }
        for (Bird other : game.players) {
            if (other == null || other.health <= 0) continue;
            if (other.ravenPortentOwnerIndex != playerIndex || other.ravenPortentTimer <= 0) continue;
            nodes.add(new RavenNode(other.bodyCenterX(), other.bodyCenterY(), other, null,
                    other.ravenPortentSerial, other.ravenPortentUltimate));
        }
        nodes.sort((a, b) -> Integer.compare(a.serial(), b.serial()));
        return nodes;
    }

    private Bird latestOwnedRavenMarkedTarget() {
        Bird best = null;
        int bestSerial = Integer.MIN_VALUE;
        for (Bird other : game.players) {
            if (other == null || other.health <= 0) continue;
            if (other.ravenPortentOwnerIndex != playerIndex || other.ravenPortentTimer <= 0) continue;
            if (other.ravenPortentSerial > bestSerial) {
                bestSerial = other.ravenPortentSerial;
                best = other;
            }
        }
        return best;
    ...
    private void consumeRavenNode(RavenNode node) {
        if (node == null) return;
        if (node.ground() != null) {
            ravenGroundPortents.remove(node.ground());
        }
        if (node.target() != null) {
    ...
    private void clearOwnedRavenPortents() {
        ravenGroundPortents.clear();
        for (Bird other : game.players) {
            if (other != null && other.ravenPortentOwnerIndex == playerIndex) {
                clearRavenPortent(other);
            }
        }
    }

    private void applyRavenPortent(Bird target, boolean ultimate) {
        if (target == null || target.health <= 0) {
            return;
        }
        target.ravenPortentOwnerIndex = playerIndex;
        target.ravenPortentUltimate = target.ravenPortentUltimate || ultimate;
    ...
    private void clearRavenPortent(Bird target) {
        if (target == null) {
            return;
        }
        target.ravenPortentTimer = 0;
        target.ravenPortentOwnerIndex = -1;
        target.ravenPortentSerial = 0;
        target.ravenPortentUltimate = false;
    }

    private void addRavenGroundPortent(double x, double y, boolean ultimate) {
        ravenGroundPortents.add(new RavenPortent(
                Math.clamp(x, 12.0, BirdGame3.WORLD_WIDTH - 12.0),
                y,
                ultimate,
                ++ravenPortentSerialCounter
        ));
        trimOwnedRavenPortents();
    }

    private void trimOwnedRavenPortents() {
        while (activeOwnedRavenNodes().size() > RAVEN_MAX_PORTENTS) {
            RavenNode oldest = activeOwnedRavenNodes().get(0);
            consumeRavenNode(oldest);
        }
    }

    private double clampRavenWarpX(double desiredX) {
        return Math.clamp(desiredX, 0.0, BirdGame3.WORLD_WIDTH - 80.0 * sizeMultiplier);
    }

    private double clampRavenWarpY(double desiredY) {
        return Math.clamp(desiredY, 0.0, BirdGame3.GROUND_Y - 80.0 * sizeMultiplier);
    }

    private Color ravenAccentColor() {
        return isVoidHeraldSkin ? Color.web("#B388FF") : Color.web("#90A4AE");
    }

    private Color ravenShadowColor(boolean ultimate) {
        return ultimate ? Color.GOLD : (isVoidHeraldSkin ? Color.web("#4A148C") : Color.web("#10151D"));
    }

    private void emitRavenBurst(double centerX, double centerY, int baseCount, Color color) {
        int particleCount = scaledParticleCount(baseCount);
        for (int i = 0; i < particleCount; i++) {
            double angle = Math.random() * Math.PI * 2.0;
            double speed = 2.0 + Math.random() * 8.0;
            game.particles.add(new Particle(
                    centerX,
                    centerY,
                    Math.cos(angle) * speed,
    ...
    Platform findCurrentSupportPlatform() {
    ...
    private void configureRazorbillAISpecialInputs(Bird target, double dist, boolean onGround) {
        if (target == null || type != BirdGame3.BirdType.RAZORBILL) {
            return;
        }
        int dir = target.bodyCenterX() >= bodyCenterX() ? 1 : -1;
        facingRight = dir > 0;
        ...
        boolean targetAttacking = target.attackAnimationTimer > 2
                ...
                || target.diveTimer > 0
                || target.isZipping;
        if (targetAttacking && dist < 205.0 && razorbillCounterReuseTimer <= 0) {
            game.setAiControlKey(playerIndex, blockKey(), true);
            return;
        }
        if (dy < -120.0 && dist < 360.0 && !razorbillUpSpecialUsed) {
            game.setAiControlKey(playerIndex, jumpKey(), true);
            return;
        }
    ...
    private void configureRavenAISpecialInputs(Bird target, double dist, boolean onGround) {
        if (target == null || type != BirdGame3.BirdType.RAVEN) {
            return;
        }
        int dir = target.bodyCenterX() >= bodyCenterX() ? 1 : -1;
        facingRight = dir > 0;
        ...
        boolean hasNode = !activeOwnedRavenNodes().isEmpty();

        if (!onGround && dy < -92.0 && !ravenLiftUsed) {
            game.setAiControlKey(playerIndex, jumpKey(), true);
            return;
        }
        if (hasNode && dist > 132.0 && dist < 520.0 && ravenSideReuseTimer <= 0
                && (targetMarked || random.nextDouble() < 0.72)) {
            game.setAiControlKey(playerIndex, dir < 0 ? leftKey() : rightKey(), true);
            return;
        }
        if (onGround && ravenDecoy == null && ravenDownReuseTimer <= 0
                && (dist < 150.0 || target.attackAnimationTimer > 2) && random.nextDouble() < 0.58) {
            game.setAiControlKey(playerIndex, blockKey(), true);
            return;
        }
        if (ravenDecoy != null && dist > 230.0 && random.nextDouble() < 0.42) {
            game.setAiControlKey(playerIndex, blockKey(), true);
        }
    }
    ...
    private void updateTimers(double gameSpeed) {
        ...
        razorbillShearTimer = Math.max(0, (int)(razorbillShearTimer - gameSpeed));
        razorbillCounterTimer = Math.max(0, (int)(razorbillCounterTimer - gameSpeed));
        ...
        if (razorbillCounterBurstTimer == 0 && razorbillCountered) {
        ...
        ravenNeutralReuseTimer = Math.max(0, (int) (ravenNeutralReuseTimer - gameSpeed));
        ravenSideTimer = Math.max(0, (int) (ravenSideTimer - gameSpeed));
    ...
    private void handleHorizontalMovement(boolean stunned, boolean airborne,
        ...
        if ((type == BirdGame3.BirdType.PIGEON && PigeonSpecials.active(this))
                ...
                if (type == BirdGame3.BirdType.ROADRUNNER && roadrunnerBeepBurstTimer > 0) {
                    ...
                    vx *= 0.98;
                } else if (type == BirdGame3.BirdType.RAZORBILL && razorbillShearTimer > 0) {
                    vx *= 0.94;
    ...
    boolean canDamageTarget(Bird other) {
    ...
    double receiveExternalDamage(double rawDamage) {
        ...
        if (tryRazorbillCounter(null, scaledDamage)) {
            return 0;
        }
    ...
    private void onDefeated() {
        ...
        batHangLockTimer = 0;
        batRehangCooldownTimer = 0;
        resetRavenSpecialState(true);
        ravenNeutralReuseTimer = 0;
        ravenSideReuseTimer = 0;
        ravenLiftUsed = false;
    ...
    LanBirdState toLanState() {
        ...
        state.razorbillStormTimer = razorbillStormTimer;
        state.razorbillStormHoldFrames = razorbillStormHoldFrames;
        ...
        state.razorbillShearUltimate = razorbillShearUltimate;
        state.razorbillUpSpecialUsed = razorbillUpSpecialUsed;
        state.razorbillCounterTimer = razorbillCounterTimer;
        state.razorbillCounterReuseTimer = razorbillCounterReuseTimer;
        state.razorbillCounterWhiffTimer = razorbillCounterWhiffTimer;
        state.razorbillCounterBurstTimer = razorbillCounterBurstTimer;
        ...
        state.ravenQuillCharging = ravenQuillCharging;
        state.ravenQuillChargeFrames = ravenQuillChargeFrames;
        state.ravenQuillChargeUltimate = ravenQuillChargeUltimate;
        state.ravenNeutralReuseTimer = ravenNeutralReuseTimer;
        state.ravenSideTimer = ravenSideTimer;
        state.ravenSideReuseTimer = ravenSideReuseTimer;
        state.ravenSideDirection = ravenSideDirection;
        state.ravenSideUltimate = ravenSideUltimate;
        state.ravenSideEmpowered = ravenSideEmpowered;
        state.ravenSideStartX = ravenSideStartX;
        state.ravenSideStartY = ravenSideStartY;
        state.ravenSideEndX = ravenSideEndX;
        state.ravenSideEndY = ravenSideEndY;
        state.ravenLiftTimer = ravenLiftTimer;
        state.ravenLiftUsed = ravenLiftUsed;
        state.ravenLiftUltimate = ravenLiftUltimate;
        state.ravenDownReuseTimer = ravenDownReuseTimer;
        state.ravenUltimateTimer = ravenUltimateTimer;
        state.ravenPortentTimer = ravenPortentTimer;
        state.ravenPortentOwnerIndex = ravenPortentOwnerIndex;
        state.ravenPortentSerial = ravenPortentSerial;
        state.ravenPortentUltimate = ravenPortentUltimate;
        state.ravenDecoyActive = ravenDecoy != null;
        if (ravenDecoy != null) {
            state.ravenDecoyX = ravenDecoy.x;
            state.ravenDecoyY = ravenDecoy.y;
            state.ravenDecoyLifeFrames = ravenDecoy.lifeFrames;
            state.ravenDecoyAgeFrames = ravenDecoy.ageFrames;
            state.ravenDecoyUltimate = ravenDecoy.ultimate;
            state.ravenDecoySwapped = ravenDecoy.swapped;
        }
    ...
    void applyLanState(LanBirdState state) {
        ...
        this.razorbillStormTimer = Math.max(0, state.razorbillStormTimer);
        this.razorbillStormHoldFrames = Math.max(0, state.razorbillStormHoldFrames);
        this.razorbillStormReuseTimer = Math.max(0, state.razorbillStormReuseTimer);
        this.razorbillStormUltimate = state.razorbillStormUltimate;
        this.razorbillStormReleased = state.razorbillStormReleased;
        Arrays.fill(this.razorbillStormHitCooldown, 0);
        if (state.razorbillStormHitCooldown != null) {
            System.arraycopy(state.razorbillStormHitCooldown, 0, this.razorbillStormHitCooldown, 0,
        ...
        this.razorbillShearUltimate = state.razorbillShearUltimate;
        this.razorbillUpSpecialUsed = state.razorbillUpSpecialUsed;
        this.razorbillCounterTimer = Math.max(0, state.razorbillCounterTimer);
        this.razorbillCounterReuseTimer = Math.max(0, state.razorbillCounterReuseTimer);
        this.razorbillCounterWhiffTimer = Math.max(0, state.razorbillCounterWhiffTimer);
        this.razorbillCounterBurstTimer = Math.max(0, state.razorbillCounterBurstTimer);
        ...
        this.ravenQuillCharging = state.ravenQuillCharging;
        this.ravenQuillChargeFrames = Math.max(0, state.ravenQuillChargeFrames);
        this.ravenQuillChargeUltimate = state.ravenQuillChargeUltimate;
        this.ravenNeutralReuseTimer = Math.max(0, state.ravenNeutralReuseTimer);
        this.ravenSideTimer = Math.max(0, state.ravenSideTimer);
        this.ravenSideReuseTimer = Math.max(0, state.ravenSideReuseTimer);
        this.ravenSideDirection = state.ravenSideDirection == 0 ? facingDirection() : state.ravenSideDirection;
        this.ravenSideUltimate = state.ravenSideUltimate;
        this.ravenSideEmpowered = state.ravenSideEmpowered;
        this.ravenSideStartX = state.ravenSideStartX;
        this.ravenSideStartY = state.ravenSideStartY;
        this.ravenSideEndX = state.ravenSideEndX;
        this.ravenSideEndY = state.ravenSideEndY;
        this.ravenLiftTimer = Math.max(0, state.ravenLiftTimer);
        this.ravenLiftUsed = state.ravenLiftUsed;
        this.ravenLiftUltimate = state.ravenLiftUltimate;
        this.ravenDownReuseTimer = Math.max(0, state.ravenDownReuseTimer);
        this.ravenUltimateTimer = Math.max(0, state.ravenUltimateTimer);
        this.ravenPortentTimer = Math.max(0, state.ravenPortentTimer);
        this.ravenPortentOwnerIndex = state.ravenPortentOwnerIndex;
        this.ravenPortentSerial = Math.max(0, state.ravenPortentSerial);
        this.ravenPortentUltimate = state.ravenPortentUltimate;
        if (state.ravenDecoyActive) {
            if (this.ravenDecoy == null) {
                this.ravenDecoy = new RavenDecoy(state.ravenDecoyX, state.ravenDecoyY, state.ravenDecoyUltimate);
            }
            this.ravenDecoy.x = state.ravenDecoyX;
            this.ravenDecoy.y = state.ravenDecoyY;
            this.ravenDecoy.lifeFrames = Math.max(0, state.ravenDecoyLifeFrames);
            this.ravenDecoy.ageFrames = Math.max(0, state.ravenDecoyAgeFrames);
            this.ravenDecoy.ultimate = state.ravenDecoyUltimate;
            this.ravenDecoy.swapped = state.ravenDecoySwapped;
        } else {
    ...
    double phoenixSpecialPhase(int timer, int totalFrames) {
        if (timer <= 0 || totalFrames <= 0) {
            return 0.0;
        }
        return Math.clamp(1.0 - ((timer - 1.0) / (double) totalFrames), 0.0, 1.0);
    ...
    private AttackVisualPose currentRavenSpecialPose() {
        ...
        if (ravenSideTimer > 0) {
            double phase = pigeonSpecialPhase(ravenSideTimer,
                    ravenSideUltimate ? RAVEN_SIDE_FRAMES + 4 : RAVEN_SIDE_FRAMES);
            return new AttackVisualPose(
                    dir * (11.0 + phase * 7.0),
                    -4.0 - phase * 2.0,
                    dir * (12.0 + phase * 7.0),
        ...
        if (ravenQuillCharging) {
            double ratio = Math.clamp(ravenQuillChargeFrames / (double) RAVEN_QUILL_CHARGE_FAN_FRAMES, 0.0, 1.0);
            double pulse = 0.5 + 0.5 * Math.sin(ravenQuillChargeFrames * 0.32);
            return new AttackVisualPose(
                    -dir * (4.0 + ratio * 5.0),
                    -3.0 - ratio * 4.0,
                    -dir * (7.0 + ratio * 8.0),
        ...
        if (ravenUltimateTimer > 0) {
            double phase = pigeonSpecialPhase(ravenUltimateTimer, RAVEN_ULTIMATE_ROUTE_LIFE_FRAMES);
            return new AttackVisualPose(
                    0.0,
                    -8.0 - phase * 5.0,
                    dir * (4.0 + phase * 2.0),
    ...
    public void draw(GraphicsContext g) {
        ...
        drawRazorbillStormAndCounter(g, drawSize);
        drawRazorbillBladestorm(g, drawSize);
        drawRazorbillSpecialFx(g, drawSize);
    ...
    private void drawRavenObjects(GraphicsContext g) {
        ...
        double s = sizeMultiplier;
        for (RavenPortent portent : ravenGroundPortents) {
            double lifeRatio = Math.clamp(portent.lifeFrames / (double) (portent.ultimate
                    ? RAVEN_PORTENT_ULTIMATE_LIFE_FRAMES : RAVEN_PORTENT_LIFE_FRAMES), 0.0, 1.0);
            double pulse = 0.5 + 0.5 * Math.sin(portent.ageFrames * 0.18);
            Color core = portent.ultimate ? Color.GOLD : ravenAccentColor();
            g.setFill(ravenShadowColor(false).deriveColor(0, 1, 1, (0.18 + pulse * 0.10) * lifeRatio));
            g.fillOval(portent.x - 40.0 * s, portent.y - 18.0 * s, 80.0 * s, 28.0 * s);
            g.setStroke(core.deriveColor(0, 1, 1, (0.50 + pulse * 0.30) * lifeRatio));
            g.setLineWidth((2.0 + pulse * 1.2) * s);
            g.strokeArc(portent.x - 24.0 * s, portent.y - 34.0 * s, 48.0 * s, 42.0 * s,
                    205, 130, ArcType.OPEN);
            g.strokeLine(portent.x, portent.y - 6.0 * s, portent.x - 10.0 * s, portent.y - 28.0 * s);
        ...
        for (RavenQuill quill : ravenQuills) {
            ...
            double normalX = -dirY;
            double normalY = dirX;
            double len = (quill.ultimate ? 28.0 : 22.0) * s;
            double width = (quill.ultimate ? 6.5 : 5.0) * s;
            g.setFill((quill.ultimate ? Color.GOLD : ravenAccentColor()).deriveColor(0, 1, 1, 0.88));
            g.fillPolygon(
                    new double[]{quill.x + dirX * len, quill.x - dirX * len * 0.42 + normalX * width,
                            quill.x - dirX * len * 0.42, quill.x - dirX * len * 0.42 - normalX * width},
                    new double[]{quill.y + dirY * len, quill.y - dirY * len * 0.42 + normalY * width,
                            quill.y - dirY * len * 0.42, quill.y - dirY * len * 0.42 - normalY * width},
                    4
            );
        }

        if (ravenDecoy != null) {
            double lifeRatio = Math.clamp(ravenDecoy.lifeFrames / (double) (ravenDecoy.ultimate
                    ? RAVEN_DECOY_ULTIMATE_LIFE_FRAMES : RAVEN_DECOY_LIFE_FRAMES), 0.0, 1.0);
            double pulse = 0.5 + 0.5 * Math.sin(ravenDecoy.ageFrames * 0.22);
            Color outline = ravenDecoy.ultimate ? Color.GOLD : ravenAccentColor();
            g.setFill(ravenShadowColor(false).deriveColor(0, 1, 1, (0.24 + pulse * 0.12) * lifeRatio));
            g.fillOval(ravenDecoy.x - 34.0 * s, ravenDecoy.y - 46.0 * s, 68.0 * s, 84.0 * s);
            g.setStroke(outline.deriveColor(0, 1, 1, (0.55 + pulse * 0.25) * lifeRatio));
            g.setLineWidth((2.4 + pulse) * s);
            g.strokeOval(ravenDecoy.x - 30.0 * s, ravenDecoy.y - 40.0 * s, 60.0 * s, 72.0 * s);
            g.strokeArc(ravenDecoy.x - 42.0 * s, ravenDecoy.y - 18.0 * s, 84.0 * s, 36.0 * s,
                    208, 124, ArcType.OPEN);
        }

        if (!ravenUltimateRoutes.isEmpty()) {
            g.setLineCap(StrokeLineCap.ROUND);
            for (RavenUltimateRoute route : ravenUltimateRoutes) {
                double lifeRatio = Math.clamp(route.lifeFrames / (double) RAVEN_ULTIMATE_ROUTE_LIFE_FRAMES, 0.0, 1.0);
                double pulse = 0.5 + 0.5 * Math.sin(route.ageFrames * 0.42);
                g.setStroke(Color.web("#120B18").deriveColor(0, 1, 1, 0.48 * lifeRatio));
                g.setLineWidth((12.0 + pulse * 4.0) * s);
                g.strokeLine(route.startX, route.startY, route.endX, route.endY);
                g.setStroke(Color.GOLD.deriveColor(0, 1, 1, (0.42 + pulse * 0.32) * lifeRatio));
    ...
    private void drawRavenSpecialFx(GraphicsContext g, double drawSize) {
        if (type != BirdGame3.BirdType.RAVEN) {
            return;
        }
        double s = sizeMultiplier;
        if (ravenQuillCharging) {
            double ratio = Math.clamp(ravenQuillChargeFrames / (double) RAVEN_QUILL_CHARGE_FAN_FRAMES, 0.0, 1.0);
            double pulse = 0.5 + 0.5 * Math.sin(ravenQuillChargeFrames * 0.34);
            g.setStroke((ravenQuillChargeUltimate ? Color.GOLD : ravenAccentColor())
                    .deriveColor(0, 1, 1, 0.36 + ratio * 0.34));
        ...
        if (ravenSideTimer > 0) {
            ...
            g.setStroke((ravenSideUltimate ? Color.GOLD : ravenAccentColor()).deriveColor(0, 1, 1, 0.50 + pulse * 0.28));
            g.setLineCap(StrokeLineCap.ROUND);
            g.setLineWidth((ravenSideEmpowered ? 5.2 : 3.4) * s);
            g.strokeLine(ravenSideStartX, ravenSideStartY, ravenSideEndX, ravenSideEndY);
            g.setStroke(ravenShadowColor(false).deriveColor(0, 1, 1, 0.38 + pulse * 0.16));
            g.setLineWidth((ravenSideEmpowered ? 12.0 : 8.0) * s);
            g.strokeLine(ravenSideStartX, ravenSideStartY, ravenSideEndX, ravenSideEndY);
        }
        if (ravenLiftTimer > 0) {
            double phase = 1.0 - Math.clamp(ravenLiftTimer / (double) (ravenLiftUltimate
                    ? RAVEN_LIFT_ULTIMATE_FRAMES : RAVEN_LIFT_FRAMES), 0.0, 1.0);
            Color lift = ravenLiftUltimate ? Color.GOLD : ravenAccentColor();
            g.setStroke(lift.deriveColor(0, 1, 1, 0.52));
            g.setLineCap(StrokeLineCap.ROUND);
            for (int i = 0; i < 4; i++) {
                double width = (36.0 + i * 20.0) * s;
                double height = (72.0 + i * 18.0 + phase * 24.0) * s;
                g.setLineWidth((2.0 + i * 0.45) * s);
                g.strokeArc(bodyCenterX() - width * 0.5, bodyCenterY() - height * 0.88,
                        width, height, 205 + i * 18, 130, ArcType.OPEN);
            }
        }
    }

    private void drawRavenPortentMarkEffect(GraphicsContext g, double drawSize) {
        if (ravenPortentTimer <= 0) {
            return;
        }
        double lifeRatio = Math.clamp(ravenPortentTimer / (double) (ravenPortentUltimate
                ? RAVEN_MARK_ULTIMATE_LIFE_FRAMES : RAVEN_MARK_LIFE_FRAMES), 0.0, 1.0);
        double pulse = 0.5 + 0.5 * Math.sin(ravenPortentTimer * 0.18);
        double s = sizeMultiplier;
        Color color = ravenPortentUltimate ? Color.GOLD : Color.web("#B0BEC5");
        g.setStroke(color.deriveColor(0, 1, 1, (0.42 + pulse * 0.32) * lifeRatio));
        g.setLineWidth((2.0 + pulse * 1.2) * s);
        g.strokeArc(bodyCenterX() - 26.0 * s, y - 22.0 * s, 52.0 * s, 30.0 * s,
                204, 132, ArcType.OPEN);
        g.strokeLine(bodyCenterX(), y - 4.0 * s, bodyCenterX() - 11.0 * s, y - 27.0 * s);
        g.strokeLine(bodyCenterX(), y - 4.0 * s, bodyCenterX() + 12.0 * s, y - 29.0 * s);
    }
    ...
    private void drawRazorbillStormAndCounter(GraphicsContext g, double drawSize) {
        ...
        if (razorbillStormTimer > 0) {
            ...
            double pulse = 0.5 + 0.5 * Math.sin((razorbillStormHoldFrames + razorbillStormTimer) * 0.45);
            Color storm = razorbillStormUltimate ? Color.GOLD.brighter() : Color.web("#CFD8DC");
            g.setEffect(new Glow(razorbillStormUltimate ? 0.82 : 0.52));
            if (razorbillStormReleased) {
                double releaseRatio = Math.clamp(razorbillStormTimer / (double) RAZORBILL_STORM_RELEASE_FRAMES, 0.0, 1.0);
                double spread = 1.0 - releaseRatio;
                double radius = (72.0 + holdRatio * 36.0 + spread * 42.0) * s;
                for (int i = 0; i < 8; i++) {
                    double angle = Math.toRadians(razorbillStormHoldFrames * 5.0 + i * 45.0 + spread * 36.0);
                    double inner = (22.0 + spread * 18.0) * s;
                    double outer = radius * (0.82 + (i % 2) * 0.10);
                    double startX = centerX + Math.cos(angle) * inner;
                    double startY = centerY + Math.sin(angle) * inner * 0.74;
                    double endX = centerX + Math.cos(angle) * outer;
                    double endY = centerY + Math.sin(angle) * outer * 0.74;
                    g.setStroke(storm.deriveColor(0, 1, 1, 0.52 + releaseRatio * 0.22));
                    g.setLineWidth((razorbillStormUltimate ? 7.0 : 5.2) * s);
                    g.strokeLine(startX, startY, endX, endY);
                    g.setStroke(Color.WHITE.deriveColor(0, 1, 1, 0.66));
                    g.setLineWidth(1.8 * s);
                    g.strokeLine(startX + Math.cos(angle) * 8.0 * s, startY + Math.sin(angle) * 5.0 * s,
                            endX - Math.cos(angle) * 12.0 * s, endY - Math.sin(angle) * 8.0 * s);
                }
                g.setStroke(storm.deriveColor(0, 1, 1, 0.26 + releaseRatio * 0.22));
                g.setLineWidth((razorbillStormUltimate ? 5.5 : 4.0) * s);
                g.strokeOval(centerX - radius * 0.72, centerY - radius * 0.52,
                        radius * 1.44, radius * 1.04);
            } else {
                double radius = (48.0 + holdRatio * 38.0 + pulse * 8.0) * s;
                for (int i = 0; i < 4; i++) {
                    double angle = razorbillStormHoldFrames * 9.5 + i * 90.0 + pulse * 22.0;
                    g.setStroke(storm.deriveColor(0, 1, 1, 0.42 + pulse * 0.22));
                    g.setLineWidth((razorbillStormUltimate ? 8.0 : 6.0) * s);
                    g.strokeArc(centerX - radius, centerY - radius * 0.78,
                            radius * 2.0, radius * 1.56,
                            angle, 58.0, ArcType.OPEN);
                    g.setStroke(Color.WHITE.deriveColor(0, 1, 1, 0.55));
                    g.setLineWidth(2.1 * s);
                    g.strokeArc(centerX - radius * 0.88, centerY - radius * 0.68,
                            radius * 1.76, radius * 1.36,
                            angle + 8.0, 42.0, ArcType.OPEN);
                }
            }
            g.setEffect(null);
        }

        if (razorbillCounterTimer > 0 || razorbillCounterBurstTimer > 0 || razorbillCounterWhiffTimer > 0) {
            boolean burst = razorbillCounterBurstTimer > 0;
            boolean whiff = razorbillCounterWhiffTimer > 0 && !burst;
            boolean activeGuard = razorbillCounterTimer > 0 && !burst && !whiff;
            double pulse = burst
                    ? Math.sin((razorbillCounterBurstTimer / (double) Math.max(1, RAZORBILL_COUNTER_BURST_FRAMES)) * Math.PI)
                    : 0.5 + 0.5 * Math.sin((razorbillCounterTimer + razorbillCounterWhiffTimer) * 0.65);
            Color edge = burst
                    ? (razorbillCounterUltimate ? Color.GOLD : Color.WHITE)
                    : whiff ? Color.web("#EF5350") : Color.web("#ECEFF1");
            g.setEffect(new Glow(burst ? 0.78 : whiff ? 0.22 : 0.48));
            if (activeGuard) {
                double dir = facingRight ? 1.0 : -1.0;
                double guardX = centerX + dir * 30.0 * s;
                double guardY = centerY - 5.0 * s;
                double shieldW = (78.0 + pulse * 10.0) * s;
                double shieldH = (94.0 + pulse * 8.0) * s;
                g.setFill(Color.web("#263238").deriveColor(0, 1, 1, 0.18));
                g.fillOval(guardX - shieldW * 0.5, guardY - shieldH * 0.5, shieldW, shieldH);
                g.setStroke(edge.deriveColor(0, 1, 1, 0.68));
                g.setLineWidth(5.2 * s);
                g.strokeArc(guardX - shieldW * 0.56, guardY - shieldH * 0.52,
                        shieldW * 1.12, shieldH * 1.04,
                        facingRight ? -72.0 : 108.0,
                        facingRight ? 144.0 : -144.0,
                        ArcType.OPEN);
                g.setStroke(Color.WHITE.deriveColor(0, 1, 1, 0.52));
                g.setLineWidth(2.0 * s);
                g.strokeArc(guardX - shieldW * 0.46, guardY - shieldH * 0.42,
                        shieldW * 0.92, shieldH * 0.84,
                        facingRight ? -62.0 : 118.0,
                        facingRight ? 124.0 : -124.0,
                        ArcType.OPEN);
                double tip1X = centerX + dir * 36.0 * s;
                double tip1Y = centerY - 42.0 * s;
                double hilt1X = centerX - dir * 28.0 * s;
                double hilt1Y = centerY + 32.0 * s;
                double tip2X = centerX + dir * 38.0 * s;
                double tip2Y = centerY + 34.0 * s;
                double hilt2X = centerX - dir * 26.0 * s;
                double hilt2Y = centerY - 34.0 * s;
                g.setStroke(Color.web("#102027").deriveColor(0, 1, 1, 0.58));
                g.setLineWidth(8.0 * s);
                g.strokeLine(hilt1X, hilt1Y, tip1X, tip1Y);
                g.strokeLine(hilt2X, hilt2Y, tip2X, tip2Y);
                g.setStroke(Color.web("#CFD8DC").deriveColor(0, 1, 1, 0.88));
                g.setLineWidth(4.4 * s);
                g.strokeLine(hilt1X, hilt1Y, tip1X, tip1Y);
                g.strokeLine(hilt2X, hilt2Y, tip2X, tip2Y);
                g.setStroke(Color.WHITE.deriveColor(0, 1, 1, 0.78));
                g.setLineWidth(1.55 * s);
                g.strokeLine(hilt1X + dir * 7.0 * s, hilt1Y - 8.0 * s,
                        tip1X - dir * 10.0 * s, tip1Y + 11.0 * s);
                g.strokeLine(hilt2X + dir * 7.0 * s, hilt2Y + 8.0 * s,
                        tip2X - dir * 10.0 * s, tip2Y - 11.0 * s);
                g.setStroke(Color.web("#5D4037").deriveColor(0, 1, 1, 0.95));
                g.setLineWidth(3.0 * s);
                g.strokeLine(hilt1X - dir * 10.0 * s, hilt1Y - 8.0 * s,
                        hilt1X + dir * 10.0 * s, hilt1Y + 8.0 * s);
                g.strokeLine(hilt2X - dir * 10.0 * s, hilt2Y + 8.0 * s,
                        hilt2X + dir * 10.0 * s, hilt2Y - 8.0 * s);
                g.setStroke((razorbillCounterUltimate ? Color.GOLD : Color.web("#B2EBF2")).deriveColor(0, 1, 1, 0.84));
                g.setLineWidth(6.2 * s);
                g.strokeArc(centerX - 52.0 * s, centerY - 42.0 * s,
                        104.0 * s, 84.0 * s,
                        facingRight ? 206.0 : -26.0,
                        facingRight ? 126.0 : -126.0,
                        ArcType.OPEN);
                g.setStroke(Color.WHITE.deriveColor(0, 1, 1, 0.62));
                g.setLineWidth(2.0 * s);
                g.strokeArc(centerX - 45.0 * s, centerY - 35.0 * s,
                        90.0 * s, 70.0 * s,
                        facingRight ? 212.0 : -32.0,
                        facingRight ? 112.0 : -112.0,
                        ArcType.OPEN);
                g.setStroke(Color.web("#B0BEC5").deriveColor(0, 1, 1, 0.82));
                g.setLineWidth(5.0 * s);
                g.strokeLine(guardX - dir * 30.0 * s, guardY + 30.0 * s,
                        guardX + dir * 32.0 * s, guardY - 32.0 * s);
                g.strokeLine(guardX - dir * 26.0 * s, guardY - 30.0 * s,
                        guardX + dir * 30.0 * s, guardY + 28.0 * s);
                g.setStroke(Color.WHITE.deriveColor(0, 1, 1, 0.72));
                g.setLineWidth(1.7 * s);
                g.strokeLine(guardX - dir * 24.0 * s, guardY + 22.0 * s,
                        guardX + dir * 24.0 * s, guardY - 26.0 * s);
                g.strokeLine(guardX - dir * 20.0 * s, guardY - 22.0 * s,
                        guardX + dir * 22.0 * s, guardY + 22.0 * s);
                for (int i = 0; i < 3; i++) {
                    double tickY = guardY + (i - 1) * 17.0 * s;
                    g.setStroke(edge.deriveColor(0, 1, 1, 0.30 + i * 0.08));
                    g.setLineWidth(1.6 * s);
                    g.strokeLine(guardX + dir * (34.0 + i * 3.0) * s, tickY,
                            guardX + dir * (48.0 + i * 4.0) * s, tickY - 8.0 * s);
                }
            } else {
                double radius = (burst ? 94.0 : 54.0) * s * (0.86 + pulse * 0.20);
                g.setStroke(edge.deriveColor(0, 1, 1, burst ? 0.72 : 0.36));
                g.setLineWidth((burst ? 7.0 : 4.0) * s);
                g.strokeArc(centerX - radius, centerY - radius * 0.66,
                        radius * 2.0, radius * 1.32,
                        facingRight ? -42.0 : 162.0,
                        facingRight ? 146.0 : -146.0,
                        ArcType.OPEN);
                g.setStroke(Color.WHITE.deriveColor(0, 1, 1, burst ? 0.62 : 0.34));
                g.setLineWidth(1.8 * s);
                g.strokeLine(centerX - (facingRight ? 22.0 : -22.0) * s, centerY + 24.0 * s,
                        centerX + (facingRight ? 58.0 : -58.0) * s, centerY - 26.0 * s);
            }
            g.setEffect(null);
        }
        g.restore();
    ...
    private void drawRazorbillSpecialFx(GraphicsContext g, double drawSize) {
        if (!isRazorbillSpecialOwner()) {
            return;
        }
        double s = sizeMultiplier;
        ...
        if (razorbillShearTimer > 0) {
            ...
            double phase = razorbillShearTimer / maxFrames;
            int dir = razorbillShearDirection == 0 ? facingDirection() : razorbillShearDirection;
            double alpha = 0.34 + phase * 0.46;
            g.setEffect(new Glow(0.52));
            g.setStroke((razorbillShearUltimate ? Color.GOLD : Color.web("#80DEEA")).deriveColor(0, 1, 1, alpha));
            g.setLineWidth((razorbillShearUltimate ? 11.0 : 8.0) * s);
            g.strokeLine(centerX - dir * 18.0 * s, centerY + 28.0 * s,
                    centerX + dir * 76.0 * s, centerY - 96.0 * s);
            g.setStroke(Color.WHITE.deriveColor(0, 1, 1, Math.min(0.95, alpha + 0.18)));
            g.setLineWidth(3.0 * s);
            g.strokeLine(centerX - dir * 8.0 * s, centerY + 16.0 * s,
                    centerX + dir * 62.0 * s, centerY - 82.0 * s);
            g.setEffect(null);
        }
    ...
    private void drawBodyAndEyes(GraphicsContext g, double drawSize, AttackVisualPose pose) {
        ...
        } else if (stylizedRazorbill && !classicPalette) {
            bodyColor = Color.web("#202B32");
            headColor = Color.web("#151B20");
        ...
        if (stylizedRazorbill) {
            Color pale = (prismRazorbill ? Color.web("#E8EAF6") : Color.web("#F5F7F4"))
                    .deriveColor(0, 1, 1, classicPalette ? 0.34 : 0.58);
            Color wingBar = (prismRazorbill ? Color.web("#C5CAE9") : Color.web("#ECEFF1"))
                    .deriveColor(0, 1, 1, classicPalette ? 0.28 : 0.42);
            double cheekX = headX + (facingRight ? 11.0 : 13.0) * s;
            double eyeLineStartX = headX + (facingRight ? 18.0 : 32.0) * s;
            double eyeLineEndX = headX + (facingRight ? 37.0 : 13.0) * s;
            g.setFill(pale);
            g.fillOval(x + 24.0 * s, y + 41.0 * s, 32.0 * s, 27.0 * s);
            g.fillOval(cheekX, headY + 25.0 * s, 26.0 * s, 9.0 * s);
            g.setStroke(wingBar);
            g.setLineCap(StrokeLineCap.ROUND);
            g.setLineWidth(1.6 * s);
            g.strokeLine(x + 22.0 * s, y + 44.0 * s, x + 58.0 * s, y + 36.0 * s);
