...
class LanBirdState {
    ...
    boolean shortHopAerialQueued;
    int shortHopAerialVariantOrdinal;
    boolean fastFallActive;
    int platformDropTimer;
    double platformDropSurfaceY;
    int jumpBufferFrames;
    int coyoteFrames;
    int attackBufferFrames;
    double cooldownRecoveryCarry;
    int dashCooldown;
    int dashTimer;
    int lastTapDir;
    long lastTapTick;
    boolean attackHeldLastFrame;
    boolean specialHeldLastFrame;
    boolean jumpHeldLastFrame;
    boolean blockHeldLastFrame;
    boolean grabHeldLastFrame;
    boolean leftHeldLastFrame;
    boolean rightHeldLastFrame;
    ...
    long ledgeInvulnerabilityStartTick;
    int ledgeHangFrames;
    ...
    int shieldRegenDelayFrames;
    int grabCooldown;
    int grabStartupTimer;
    int grabbedTargetPlayerIndex = -1;
    int grabbedByPlayerIndex = -1;
    int grabHoldTimer;
    ...
    int dodgeInvulnerabilityDelayTimer;
    int dodgePendingInvulnerabilityFrames;
    int dodgeCooldown;
    int dodgeDirection;
    int dodgeVerticalDirection;
    ...
    double lastLaunchAngleDegrees;
    double lastDirectionalInfluenceDegrees;
    double lastSdiX;
    double lastSdiY;
    ...
    long currentMoveStaleSerial;
    long lastCommittedStaleSerial;
    double currentMoveStaleMultiplier = 1.0;
    String currentStaleMoveName = "READY";
    double pendingMoveKnockbackMultiplier = 1.0;
    int attackInteractionTimer;
    int lastAttackInteractionOrdinal;
    ...
    void write(DataOutputStream out) throws IOException {
        ...
        out.writeBoolean(shortHopAerialQueued);
        out.writeInt(shortHopAerialVariantOrdinal);
        out.writeBoolean(fastFallActive);
        out.writeInt(platformDropTimer);
        out.writeDouble(platformDropSurfaceY);
        out.writeInt(jumpBufferFrames);
        out.writeInt(coyoteFrames);
        out.writeInt(attackBufferFrames);
        out.writeDouble(cooldownRecoveryCarry);
        out.writeInt(dashCooldown);
        out.writeInt(dashTimer);
        out.writeInt(lastTapDir);
        out.writeLong(lastTapTick);
        out.writeBoolean(attackHeldLastFrame);
        out.writeBoolean(specialHeldLastFrame);
        out.writeBoolean(jumpHeldLastFrame);
        out.writeBoolean(blockHeldLastFrame);
        out.writeBoolean(grabHeldLastFrame);
        out.writeBoolean(leftHeldLastFrame);
        out.writeBoolean(rightHeldLastFrame);
        ...
        out.writeInt(mockingbirdBlowbackTimer);
        ...
        out.writeLong(ledgeInvulnerabilityStartTick);
        ...
        out.writeInt(shieldRegenDelayFrames);
        out.writeInt(grabCooldown);
        out.writeInt(grabStartupTimer);
        out.writeInt(grabbedTargetPlayerIndex);
        out.writeInt(grabbedByPlayerIndex);
        ...
        out.writeInt(dodgeInvulnerabilityDelayTimer);
        out.writeInt(dodgePendingInvulnerabilityFrames);
        out.writeInt(dodgeCooldown);
        out.writeInt(dodgeDirection);
        out.writeInt(dodgeVerticalDirection);
        out.writeBoolean(airDodgeAvailable);
        out.writeInt(dodgeStaleLevel);
        ...
        out.writeDouble(lastLaunchAngleDegrees);
        out.writeDouble(lastDirectionalInfluenceDegrees);
        ...
        out.writeLong(currentMoveStaleSerial);
        out.writeLong(lastCommittedStaleSerial);
        out.writeDouble(currentMoveStaleMultiplier);
        out.writeUTF(currentStaleMoveName == null ? "READY" : currentStaleMoveName);
        out.writeDouble(pendingMoveKnockbackMultiplier);
        out.writeInt(attackInteractionTimer);
        out.writeInt(lastAttackInteractionOrdinal);
    ...
    static LanBirdState read(DataInputStream in) throws IOException {
        ...
        state.shortHopAerialQueued = in.readBoolean();
        state.shortHopAerialVariantOrdinal = in.readInt();
        state.fastFallActive = in.readBoolean();
        state.platformDropTimer = in.readInt();
        state.platformDropSurfaceY = in.readDouble();
        state.jumpBufferFrames = in.readInt();
        state.coyoteFrames = in.readInt();
        state.attackBufferFrames = in.readInt();
        state.cooldownRecoveryCarry = in.readDouble();
        state.dashCooldown = in.readInt();
        state.dashTimer = in.readInt();
        state.lastTapDir = in.readInt();
        state.lastTapTick = in.readLong();
        state.attackHeldLastFrame = in.readBoolean();
        state.specialHeldLastFrame = in.readBoolean();
        state.jumpHeldLastFrame = in.readBoolean();
        state.blockHeldLastFrame = in.readBoolean();
        state.grabHeldLastFrame = in.readBoolean();
        state.leftHeldLastFrame = in.readBoolean();
        state.rightHeldLastFrame = in.readBoolean();
        ...
        state.mockingbirdBlowbackTimer = in.readInt();
        ...
        state.ledgeInvulnerabilityStartTick = in.readLong();
        ...
        state.shieldRegenDelayFrames = in.readInt();
        state.grabCooldown = in.readInt();
        state.grabStartupTimer = in.readInt();
        state.grabbedTargetPlayerIndex = in.readInt();
        state.grabbedByPlayerIndex = in.readInt();
        ...
        state.dodgeInvulnerabilityDelayTimer = in.readInt();
        state.dodgePendingInvulnerabilityFrames = in.readInt();
        state.dodgeCooldown = in.readInt();
        state.dodgeDirection = in.readInt();
        state.dodgeVerticalDirection = in.readInt();
        state.airDodgeAvailable = in.readBoolean();
        state.dodgeStaleLevel = in.readInt();
        ...
        state.lastLaunchAngleDegrees = in.readDouble();
        state.lastDirectionalInfluenceDegrees = in.readDouble();
        ...
        state.currentMoveStaleSerial = in.readLong();
        state.lastCommittedStaleSerial = in.readLong();
        state.currentMoveStaleMultiplier = in.readDouble();
        state.currentStaleMoveName = in.readUTF();
        state.pendingMoveKnockbackMultiplier = in.readDouble();
        state.attackInteractionTimer = in.readInt();
        state.lastAttackInteractionOrdinal = in.readInt();
