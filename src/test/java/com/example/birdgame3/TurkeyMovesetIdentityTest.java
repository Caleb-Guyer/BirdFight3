...
class TurkeyMovesetIdentityTest {
    ...
    void turkeyBackAirUsesItsTailFanSlamPose() throws Exception {
        ...
        Bird grinchHawk = airborneBird(game, BirdGame3.BirdType.GRINCHHAWK, 2, 320.0);
