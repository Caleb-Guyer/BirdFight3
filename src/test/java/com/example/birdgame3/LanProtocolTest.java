...
class LanProtocolTest {
    ...
    void lanBirdStateRoundTripsDodgeFields() throws IOException {
        ...
        state.dodgeTimer = 17;
        state.dodgeTotalFrames = 26;
        state.dodgeInvulnerabilityTimer = 9;
        state.dodgeInvulnerabilityDelayTimer = 2;
        state.dodgePendingInvulnerabilityFrames = 11;
        state.dodgeCooldown = 6;
        state.dodgeDirection = -1;
        state.airDodgeAvailable = false;
        state.dodgeStaleLevel = 4;
        state.dodgeStaleRecoveryTimer = 77;
        ...
        state.ledgeInvulnerabilityStartTick = 1234L;
        ...
        state.kiwiProbeTimer = 14;
        state.kiwiProbeReuseTimer = 31;
        state.kiwiProbeDirection = -1;
        state.kiwiProbeStrikeIndex = 2;
        state.kiwiProbeHit[1] = true;
        state.kiwiBurrowTimer = 22;
        state.kiwiBurrowReuseTimer = 49;
        state.kiwiBurrowDirection = -1;
        state.kiwiBurrowGrounded = true;
        state.kiwiBurrowErupted = true;
        state.kiwiBurrowHit[2] = true;
        state.kiwiSpringTimer = 17;
        state.kiwiSpringReuseTimer = 38;
        state.kiwiSpringDirection = 1;
        state.kiwiSpringUsed = true;
        state.kiwiSpringHit[3] = true;
        state.kiwiStompTimer = 19;
        state.kiwiStompReuseTimer = 44;
        state.kiwiStompAirborne = true;
        state.kiwiStompImpactResolved = true;
        state.kiwiStompImpactFxTimer = 7;
        state.kiwiStompHit[0] = true;
        state.kiwiUltimateTimer = 123;
        state.kiwiUltimateDirection = -1;
        state.kiwiUltimateWaveIndex = 4;
        state.kiwiUltimateFinalResolved = true;
        state.kiwiUltimateHitCooldown[2] = 9;
        ...
        assertEquals(26, decoded.dodgeTotalFrames);
        assertEquals(9, decoded.dodgeInvulnerabilityTimer);
        assertEquals(2, decoded.dodgeInvulnerabilityDelayTimer);
        assertEquals(11, decoded.dodgePendingInvulnerabilityFrames);
        assertEquals(6, decoded.dodgeCooldown);
        assertEquals(-1, decoded.dodgeDirection);
        assertFalse(decoded.airDodgeAvailable);
        assertEquals(4, decoded.dodgeStaleLevel);
        assertEquals(77, decoded.dodgeStaleRecoveryTimer);
        ...
        assertEquals(1234L, decoded.ledgeInvulnerabilityStartTick);
        ...
        assertEquals(14, decoded.kiwiProbeTimer);
        assertEquals(31, decoded.kiwiProbeReuseTimer);
        assertEquals(-1, decoded.kiwiProbeDirection);
        assertEquals(2, decoded.kiwiProbeStrikeIndex);
        assertTrue(decoded.kiwiProbeHit[1]);
        assertEquals(22, decoded.kiwiBurrowTimer);
        assertEquals(49, decoded.kiwiBurrowReuseTimer);
        assertEquals(-1, decoded.kiwiBurrowDirection);
        assertTrue(decoded.kiwiBurrowGrounded);
        assertTrue(decoded.kiwiBurrowErupted);
        assertTrue(decoded.kiwiBurrowHit[2]);
        assertEquals(17, decoded.kiwiSpringTimer);
        assertEquals(38, decoded.kiwiSpringReuseTimer);
        assertEquals(1, decoded.kiwiSpringDirection);
        assertTrue(decoded.kiwiSpringUsed);
        assertTrue(decoded.kiwiSpringHit[3]);
        assertEquals(19, decoded.kiwiStompTimer);
        assertEquals(44, decoded.kiwiStompReuseTimer);
        assertTrue(decoded.kiwiStompAirborne);
        assertTrue(decoded.kiwiStompImpactResolved);
        assertEquals(7, decoded.kiwiStompImpactFxTimer);
        assertTrue(decoded.kiwiStompHit[0]);
        assertEquals(123, decoded.kiwiUltimateTimer);
        assertEquals(-1, decoded.kiwiUltimateDirection);
        assertEquals(4, decoded.kiwiUltimateWaveIndex);
        assertTrue(decoded.kiwiUltimateFinalResolved);
        assertEquals(9, decoded.kiwiUltimateHitCooldown[2]);
    }
}
